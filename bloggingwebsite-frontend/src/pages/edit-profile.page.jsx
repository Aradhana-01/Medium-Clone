                ...
                <form ref={editProfileForm}>
                    ...
                    <div className="flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10">
                        <div className="max-lg:center mb-5">
                            <label htmlFor="uploadImg" id="profileImgLabel" className="relative block w-48 h-48 bg-grey rounded-full overflow-hidden border border-grey-200">
                                <div className="w-full h-full absolute top-0 left-0 text-white bg-black/80 opacity-0 hover:opacity-100 cursor-pointer ">
                                <div className="flex items-center justify-center mt-7">
                                <i className="fi fi-br-upload text-5xl text-center"></i>&nbsp;
                                </div> 
                                <div className="flex items-center justify-center "> Upload Image </div>
                                </div>
                                <img ref={profileImg} src={profile_img}/>
                            </label>

                            <input type="file" id="uploadImg" accepts=".jpeg, .png, .jpg" hidden  onChange={handleImagePreview}/>
                            ...
                            <p className="mt-6 text-dark-grey">Add you social handles below</p>
