...
export const PublishForm  = () => {
    ...
    const publishBlog = (e) =>{
      ...
      // console.log(e.target.classList.contains('disable'));
    ...
    return (
      <AnimationWrapper>
        ...
        {/* line-clamp-2 means max only two lines will be shown not more than that */}
        ...
        <div className="border-grey lg:border-1 lg:pl-8">
         ...
         <p className="mt-1 text-dark-grey text-sm text-right">
          ...
          <p className="mt-1 md-4 text-dark-grey text-right">
